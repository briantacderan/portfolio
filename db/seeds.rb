...
srt7 = Stone.create(stacks: ["icons/rust-icon.png", "icons/rust-logo.png", "icons/full-stack-icon.png"], racks: ["Rustacean Persuasion", "What does the crab say?!", "Top Rustacean Bait"], tags: ["I am officially persuaded... I love the versatility and ease to put this together. This compliled language has so many resources created by the Rustacean community, and I am interested to see what else I can learn", "Money, money, money! Just kidding, but I'm sure Rust is going to explode with business. Building a Rust app such as this tutorial boilerplate is comparable to the ease of developing an app using Ruby on Rails", "Im impressed with the standard documentation set up of Rust crates, allowing developers to easily understand each others packages and libraries. Such a good mix of all major programming languages"], project_id: p4.id)
