# heroku restart && heroku pg:reset DATABASE_URL && heroku run rake db:migrate && heroku run rake db:seed

p1 = Project.create(title: "Hoodcast", type_of: "Web scraping data analysis", main: "Python", main_framework: "Flask", description: "Scrapes SEC EDGAR for company financial statements, styled into neat and easy-to-read tables", image: "hc-gold.svg", git_url: "https://github.com/briantacderan/hoodcast-gold", website_url: "https://hoodcast.gold", preview_file: "example.gif", additional_info: "includes additional module called Hoodflex for web crawling", id_tag: "hoodcast-project")

p2 = Project.create(title: "Cookies by Relle", type_of: "E-commerce", main: "Ruby", main_framework: "Rails", description: "Custom e-commerce website for a cookie shop", image: "cookies.svg", git_url: "https://github.com/briantacderan/rellescookies", website_url: "https://rellescookies.com", preview_file: "cookie-ex.gif", additional_info: "Includes Stripe API payment system", id_tag: "cookies-project")

p3 = Project.create(title: "FM Fitness", type_of: "Customizable subscription service", main: "Ruby", main_framework: "Rails", description: "Personal training website to include calendar reservation and subscription payment systems", image: "fmf_logo.png", git_url: "https://github.com/briantacderan/fm_fitness", website_url: "https://fm-fitness.herokuapp.com", preview_file: "", additional_info: "Includes Stripe API payment system and will add Google Calendar API", id_tag: "fitness-project")

p4 = Project.create(title: "Gold Medal Metrics", type_of: "Data science", main: "Python", main_framework: "Flask", description: "Codecademy Data Science Project organizing Olympic gold medal data for every country", image: "gold-medal.png", git_url: "https://github.com/briantacderan/gold-medal-flask", website_url: "https://gold-metric-flask.herokuapp.com/", preview_file: "", additional_info: "Completed Data Science project with additional CSS enchancing", id_tag: "codecademy-datascience")
 
p5 = Project.create(title: "Jammming", type_of: "Spotify API one pager", main: "javascript", main_framework: "MERN", description: "Codecademy Project featuring full stack React framework with testing", image: "jammyjam.png", git_url: "", website_url: "https://jammyjamjam4life.surge.sh", preview_file: "", additional_info: "", id_tag: "codecademy-react")

p6 = Project.create(title: "Storeo", type_of: "image sharing website", main: "Python, Ruby", main_framework: "Flask, Ruby on Rails", description: "Codecademy project I completed in both Ruby on Rails and Flask for practice", image: "storeo-logo.png", git_url: "https://github.com/briantacderan/storeo-plus", website_url: "https://storeo-flask.herokuapp.com/", preview_file: "", additional_info: "Used as base for some of my projects like FM Fitness", id_tag: "codecademy-framework")
