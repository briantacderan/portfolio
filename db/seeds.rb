...
p1 = Project.create(title: "FM Fitness", type_of: "Customizable subscription service", main: "SwiftUI", main_framework: "Rails", description: "Personal training website to include booking reservation and subscription payment systems", image: "fm-fitness.svg", git_url: "https://github.com/briantacderan/fm_fitness", website_url: "https://fm-fitness.herokuapp.com", preview_file: "fitness-ex.gif", additional_info: "Built on SwiftUI iOS and on web with Ruby on Rails", id_tag: "fitness-project")
...
srt1 = Stone.create(stacks: ["icons/swift-icon.png", "icons/rails-icon.png", "icons/stripe-icon.png"], racks: ["The ARC", "UX-focused Booking System", "The ARC"], tags: ["FMFitness is my latest project that my friend asked me to build for his personal business. Being the main project I have been focused on, as Java and Swift/iOS was completely new to me, and after half a year into mobile development, I'm loving it.", "Finally enabled an admin page where my friend would easily be able to navigate, manage appointments. Would want to add many more features to practice for future projects", "Concurrency/Async methods in mobile dev has definitely shown the importance of why testing is very important, especially if working with enterprise-sized software"], project_id: p1.id)
