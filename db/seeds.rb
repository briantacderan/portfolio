...
p1 = Project.create(title: "FM Fitness", type_of: "Customizable subscription service", main: "SwiftUI", main_framework: "Rails", description: "Personal training website to include booking reservation and Stripe payment API with owner user-friendly admin control", image: "fm-fitness.svg", git_url: "https://github.com/briantacderan/fm_fitness", website_url: "https://fm-fitness.herokuapp.com", preview_file: "fitness-ex.gif", additional_info: "Built on SwiftUI iOS and on web with Ruby on Rails", id_tag: "fitness-project")
