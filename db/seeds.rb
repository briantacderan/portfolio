...
srt3 = Stone.create(stacks: ["icons/rails-icon.png", "icons/stripe-icon.png"], racks: ["Big Goals", "1) Enable Booking system w/ Calendar", "2) Enable Stripe API Subscriptions"], tags: ["FMFitness is my newest project that my friend asked me to build for his personal business. Luckily, there is no rush because building a multiple association modeling system is daunting but surely exciting!", "I plan to bring in a layered booking system that easily connects with an admin page where my friend would easily be able to navigate, manage appointments, and collect necessary data that could reveal potential growth points and track unseen opportunities", "Enabling stripe will be slightly different this time because the addition of subscriptions and the connection of the appointment models"], project_id: p3.id)

srt4 = Stone.create(stacks: ["icons/java-android.png", "icons/gradle-icon.png", "icons/material-icon.png"], racks: ["Dichotomous indeed!", "Android Studio", "So much room for..."], tags: ["Creating this basic trivia game app was suprisingly difficult and easy at the same time. Theres an abundance of resources online to navigate the structure of what it should come to be", "This swiss-army knife of IDEs allowed me to appreciate why Java, Rust, and other compiling languages take the lead over Python or JS. When it comes to OOP, Android Studio with Java makes the app you're building a bit more tangible than I'm used to", "activities! Speaking more on OOP, its wonderful to see a process organized into specific places within the folder tree of the app. I can see things more clearly, especially when thinking of security, speed, and debugging"], project_id: p4.id)
