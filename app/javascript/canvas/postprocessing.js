...
var POSTPROCESSING = (() => {
  ...
  var dummyCamera = /* @__PURE__ */ new THREE.Camera();
  var geometry = null;
  ...
  var revision = Number(THREE.REVISION.replace(/\D+/g, ""));
  ...
  // src/materials/BokehMaterial.js
  var BokehMaterial = class extends THREE.ShaderMaterial {
    /**
  ...
  // src/materials/CircleOfConfusionMaterial.js
  var CircleOfConfusionMaterial = class extends THREE.ShaderMaterial {
    /**
    ...
    constructor(camera) {
      super({
        ...
        uniforms: {
          ...
          focusRange: new THREE.Uniform(0),
  ...
  // src/materials/MaskMaterial.js
  var MaskMaterial = class extends THREE.ShaderMaterial {
    /**
    ...
    set maskTexture(value) {
      ...
      if (value.type !== THREE.UnsignedByteType) {
  ...
  var DepthOfFieldEffect = class extends Effect {
    ...
    constructor(camera, {
      ...
      super("DepthOfFieldEffect", depth_of_field_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["farCoCBuffer", new THREE.Uniform(null)],
          ["scale", new THREE.Uniform(1)]
        ])
      });
      this.camera = camera;
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer !== null && renderer.outputColorSpace === THREE.SRGBColorSpace) {
          this.renderTarget.texture.colorSpace = THREE.SRGBColorSpace;
          this.renderTargetNear.texture.colorSpace = THREE.SRGBColorSpace;
          this.renderTargetFar.texture.colorSpace = THREE.SRGBColorSpace;
  ...
  // src/materials/GodRaysMaterial.js
  var GodRaysMaterial = class extends THREE.ShaderMaterial {
    /**
    ...
    constructor(lightPosition) {
      super({
        ...
        uniforms: {
          ...
          density: new THREE.Uniform(1),
          decay: new THREE.Uniform(1),
          weight: new THREE.Uniform(1),
          exposure: new THREE.Uniform(1),
          clampMax: new THREE.Uniform(1)
        },
        blending: THREE.NoBlending,
        toneMapped: false,
        depthWrite: false,
  ...
  // src/effects/GodRaysEffect.js
  var v = /* @__PURE__ */ new THREE.Vector3();
  var m = /* @__PURE__ */ new THREE.Matrix4();
  var GodRaysEffect = class extends Effect {
    ...
    constructor(camera, lightSource, {
      ...
      this.renderTargetLight = new THREE.WebGLRenderTarget(1, 1);
      this.renderTargetLight.texture.name = "GodRays.Light";
      this.renderTargetLight.depthTexture = new THREE.DepthTexture();
      this.renderPassLight = new RenderPass(this.lightScene, camera);
      this.renderPassLight.clearPass.overrideClearColor = new THREE.Color(0);
    ...
    initialize(renderer, alpha, frameBufferType) {
      ...
      if (frameBufferType !== void 0) {
        ...
        if (renderer !== null && renderer.outputColorSpace === THREE.SRGBColorSpace) {
          this.renderTargetA.texture.colorSpace = THREE.SRGBColorSpace;
          this.renderTargetB.texture.colorSpace = THREE.SRGBColorSpace;
          this.renderTargetLight.texture.colorSpace = THREE.SRGBColorSpace;
        }
      }
    }
  };
    ...
    constructor({
      ...
      super("LensDistortionEffect", lens_distortion_default, {
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["principalPoint", new THREE.Uniform(principalPoint)],
          ["focalLength", new THREE.Uniform(focalLength)],
          ["skew", new THREE.Uniform(skew)]
        ])
      });
    }
    /**
  ...
  var LUT1DEffect = class extends Effect {
    ...
    constructor(lut, { blendFunction = BlendFunction.SRC } = {}) {
      super("LUT1DEffect", lut_1d_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([["lut", new THREE.Uniform(null)]])
      });
      this.lut = lut;
    }
    /**
    ...
    set lut(value) {
      ...
      if (value !== null && (value.type === THREE.FloatType || value.type === THREE.HalfFloatType)) {
  ...
  // src/textures/lut/LookupTexture.js
  var c = /* @__PURE__ */ new THREE.Color();
  var LookupTexture = class _LookupTexture extends THREE.Data3DTexture {
    /**
    ...
    constructor(data, size) {
      ...
      this.domainMax = new THREE.Vector3(1, 1, 1);
    }
    /**
    ...
    applyLUT(lut) {
      ...
      } else if (lut.type !== THREE.FloatType || this.type !== THREE.FloatType) {
        console.error("Both LUTs must be FloatType textures");
      } else if (lut.format !== THREE.RGBAFormat || this.format !== THREE.RGBAFormat) {
    ...
    toDataTexture() {
      ...
      const texture = new THREE.DataTexture(this.image.data, width, height);
  ...
  var LUT3DEffect = class extends Effect {
    ...
    constructor(lut, {
      ...
      super("LUT3DEffect", lut_3d_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["scale", new THREE.Uniform(new THREE.Vector3())],
          ["offset", new THREE.Uniform(new THREE.Vector3())],
          ["domainMin", new THREE.Uniform(null)],
          ["domainMax", new THREE.Uniform(null)]
        ])
      });
    ...
    set lut(value) {
      ...
      if (this.lut !== value) {
        ...
        if (value !== null) {
          ...
          if (value.type === THREE.FloatType || value.type === THREE.HalfFloatType) {
            defines.set("LUT_PRECISION_HIGH", "1");
          }
          if (image.width > image.height) {
            defines.set("LUT_STRIP_HORIZONTAL", "1");
          } else if (value instanceof THREE.Data3DTexture) {
    ...
    updateScaleOffset() {
      ...
      if (lut !== null) {
        ...
        if (this.tetrahedralInterpolation && lut instanceof THREE.Data3DTexture) {
    ...
    configureTetrahedralInterpolation() {
      ...
      if (lut !== null) {
        ...
        if (this.tetrahedralInterpolation) {
          if (lut instanceof THREE.Data3DTexture) {
    ...
    set manualDoF(value) {
      if (this.manualDoF !== value) {
        if (value) {
          ...
          this.uniforms.get("dof").value = new THREE.Vector4(0.2, 1, 0.2, 2);
        } else {
    ...
    constructor({ blendFunction = BlendFunction.OVERLAY, density = 1.25, scrollSpeed = 0 } = {}) {
      super("ScanlineEffect", scanlines_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["scrollSpeed", new THREE.Uniform(0)]
        ])
      });
      this.resolution = new THREE.Vector2();
      this.d = density;
  ...
  var ab = /* @__PURE__ */ new THREE.Vector3();
  var ShockWaveEffect = class extends Effect {
     ...
     */
    constructor(camera, position = new THREE.Vector3(), {
      speed = 2,
      maxRadius = 1,
      waveSize = 0.2,
      amplitude = 0.05
      ...
      super("ShockWaveEffect", shock_wave_default, {
        ...
        uniforms: /* @__PURE__ */ new Map([
          ...
          ["cameraDistance", new THREE.Uniform(1)],
          ["size", new THREE.Uniform(1)],
  ...
  var SepiaEffect = class extends Effect {
    ...
    constructor({ blendFunction, intensity = 1 } = {}) {
      super("SepiaEffect", sepia_default, {
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["weightsR", new THREE.Uniform(new THREE.Vector3(0.393, 0.769, 0.189))],
          ["weightsG", new THREE.Uniform(new THREE.Vector3(0.349, 0.686, 0.168))],
          ["weightsB", new THREE.Uniform(new THREE.Vector3(0.272, 0.534, 0.131))]
        ])
      });
    }
    /**
  ...
  var TiltShiftBlurMaterial = class extends KawaseBlurMaterial {
    ...
    constructor({
      ...
      this.fragmentShader = updateFragmentShader(this.fragmentShader);
      this.uniforms.aspect = new THREE.Uniform(1);
      this.uniforms.rotation = new THREE.Uniform(new THREE.Vector2());
      this.uniforms.maskParams = new THREE.Uniform(new THREE.Vector4());
      this._offset = offset;
  ...
  var TiltShiftEffect = class extends Effect {
    ...
    constructor({
      ...
      super("TiltShiftEffect", tilt_shift_default, {
        ...
        blendFunction,
        uniforms: /* @__PURE__ */ new Map([
          ["rotation", new THREE.Uniform(new THREE.Vector2())],
          ["maskParams", new THREE.Uniform(new THREE.Vector2())],
          ["map", new THREE.Uniform(null)]
        ])
      });
      this._offset = offset;
  ...
  var LUT3dlLoader = class extends THREE.Loader {
    /**
     * Loads a LUT.
     *
    ...
    load(url, onLoad = () => {
      ...
      const internalManager = new THREE.LoadingManager();
      const loader = new THREE.FileLoader(internalManager);
  ...
  var LUTCubeLoader = class extends THREE.Loader {
    /**
     * Loads a LUT.
     *
  ...
  var SMAAImageLoader = class extends THREE.Loader {
    /**
  ...
  // src/materials/BoxBlurMaterial.js
  var BoxBlurMaterial = class extends THREE.ShaderMaterial {
    /**
  ...
  // src/materials/DepthCopyMaterial.js
  var DepthCopyMaterial = class extends THREE.ShaderMaterial {
    /**
    ...
    constructor() {
      super({
        ...
        uniforms: {
          depthBuffer: new THREE.Uniform(null),
          texelPosition: new THREE.Uniform(new THREE.Vector2())
        },
        blending: THREE.NoBlending,
        toneMapped: false,
        depthWrite: false,
  ...
  // src/materials/GaussianBlurMaterial.js
  var GaussianBlurMaterial = class extends THREE.ShaderMaterial {
    /**
     * Constructs a new convolution material.
     *
     * @param {Object} [options] - The options.
  ...
  var BoxBlurPass = class extends Pass {
    ...
    constructor({
      ...
      this.renderTargetA = new THREE.WebGLRenderTarget(1, 1, { depthBuffer: false });
      this.renderTargetA.texture.name = "Blur.Target.A";
      this.renderTargetB = new THREE.WebGLRenderTarget(1, 1, { depthBuffer: false });
      this.renderTargetB.texture.name = "Blur.Target.B";
  ...
  var DepthCopyPass = class extends Pass {
     ...
     */
    constructor({ depthPacking = THREE.RGBADepthPacking } = {}) {
      super("DepthCopyPass");
      ...
      this.needsSwap = false;
      this.renderTarget = new THREE.WebGLRenderTarget(1, 1, {
        type: depthPacking === THREE.RGBADepthPacking ? THREE.UnsignedByteType : THREE.FloatType,
        minFilter: THREE.NearestFilter,
        magFilter: THREE.NearestFilter,
        depthBuffer: false
      });
  ...
  var DepthPickingPass = class extends DepthCopyPass {
     ...
     */
    constructor({ depthPacking = THREE.RGBADepthPacking, mode = DepthCopyMode.SINGLE } = {}) {
      super({ depthPacking });
      this.name = "DepthPickingPass";
      this.fullscreenMaterial.mode = mode;
      this.pixelBuffer = depthPacking === THREE.RGBADepthPacking ? new Uint8Array(4) : new Float32Array(4);
      this.callback = null;
    }
    /**
    ...
    render(renderer, inputBuffer, outputBuffer, deltaTime, stencilTest) {
      ...
      if (this.callback !== null) {
        ...
        const packed = renderTarget.texture.type !== THREE.FloatType;
        let x = 0, y = 0;
...
`;
      ...
      if (mainImageExists) {
        if (effect.inputColorSpace !== null && effect.inputColorSpace !== data.colorSpace) {
          fragmentMainImage += effect.inputColorSpace === THREE.SRGBColorSpace ? "color0 = LinearTosRGB(color0);\n	" : "color0 = sRGBToLinear(color0);\n	";
        }
